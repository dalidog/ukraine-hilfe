...
function About() {
    return (
        <>
            <h3>HOW IT BEGAN</h3>
            <p>Putin began his invasion of Ukraine on February 24 2022. 190,000 Russian troops began flooding into the country in tanks from Belarus, Kharkiv, and Crimea <a href="#source11" target="_blank" rel="noopener noreferrer">(11)</a>. In the first hours, explosions from missiles and drones were witness throughout the country1. The capital, Kyiv, was hit the hardest as Putin planned to capture the city and install a pro-Moscow government <a href="#source11" target="_blank" rel="noopener noreferrer">(11)</a>.
                ...
                When realizing that no one was coming to defend them, Ukrainians turned to valiantly defending themselves: demonstrating a resilience that shocked the enemy and the world. Ukrainian’s resistance came in all shapes and sizes-- from the valiant army defending their homeland at the front lines, to farmers dragging off enemy tanks with their tractors5, to civilians continuing to hold schools and celebrations in Metros (underground subways)<a href="#source7" target="_blank" rel="noopener noreferrer">(7)</a> <a href="#source8" target="_blank" rel="noopener noreferrer">(8)</a> rather withering away in despair as the enemy aimed to do.

                Putin failed to capture Kyiv and destroy Ukraine’s unity; However, so he turned to committing war crimes.
            </p>
            <h3>WAR CRIMES</h3>
            <p>In the first two months, 5 million Ukrainians fled the country (11% of the whole population); 10 million overall were displaced by the conflict in the first month<a href="#source3" target="_blank" rel="noopener noreferrer">(3)</a> <a href="#source4" target="_blank" rel="noopener noreferrer">(4)</a>. Rockets and artillery strikes rained upon cities indiscriminately hitting schools, hospitals, energy grids, water treatment plants and cultural sites-- depriving the civilians of resources to survive.11 When Ukrainians tried to flee, escape routes and humanitarian passages were blockaded (Mariuple<a href="#source12" target="_blank" rel="noopener noreferrer">(12)</a>). Retreating Russian armies left behind empty villages where every civilian was either raped, tortured, executed, before being burried in a mass grave (Irpin and Bucha)<a href="#source11" target="_blank" rel="noopener noreferrer">(11)</a>.</p>
            <p>
            Outside of Ukraine, people witnessing these atrocities too started to come together to find inventive ways to fight the war from afar through monetary donations and humanitarian aid. However, while aid comes in abundance from all over the world, it crucially requires a reliable transportation to the location from the outside and within the country. Observing the flow of resources, the Russian army has turned to blocking the humanitarian supply chains-- yet another a war crime-- through the indiscriminate target of any moving vehicle, from ambulances<a href="#source10" target="_blank" rel="noopener noreferrer">(10)</a>, to civilian cars<a href="#source9" target="_blank" rel="noopener noreferrer">(9)</a>, to even cyclists<a href="#source13" target="_blank" rel="noopener noreferrer">(13)</a>,<a href="#source14" target="_blank" rel="noopener noreferrer">(14)</a>, with drones. Because of this, the need for any vehicle is dire and constantly requested by the Ukrainian brigades on the front lines.</p>
            <h3>OUR MISSION</h3>
            <p>From the very early days of the invasion Igor, founder of <i>Ukraine-Hilfe</i>, began collecting money for the purchase and transport of SUVs to the requested locations. He would travel on his own accord and drive the car to across multiple countries in trip to reach the Polish border. The next day, they would travel non-stop from Western Ukraine to the war zone in Eastern Ukraine. Before opening this charity, Igor and his close family and friends had, on their own funds and time, successfully delivered nearly a hundred cars including some ambulances-- potentially saving upon hundreds of lives. However, understanding that the demand for vehicles in Ukraine is much higher than his sole capabilities, Igor moved forward to start <i>Ukraine-Hilfe</i> with the aim of raising revenue and resources for this purpose. <i>Ukraine-Hilfe</i> became an official charity on January 31, 2025.</p>
            <h3>SOURCES</h3>
            <ol type="1">
                    <li id="source1">
